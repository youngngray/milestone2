...
static void _LEAD_ROVER_Tasks(void);
...
void SYS_Tasks ( void )
{
    ...
    /* Create OS Thread for LEAD_ROVER Tasks. */
    xTaskCreate((TaskFunction_t) _LEAD_ROVER_Tasks,
                "LEAD_ROVER Tasks",
                1024, NULL, 1, NULL);
...
/*******************************************************************************
  Function:
    void _LEAD_ROVER_Tasks ( void )

  Summary:
    Maintains state machine of LEAD_ROVER.
*/
